...
const createBandData_1 = __importDefault(require("../../data/band/createBandData"));
...
const createBandService = (data, logo, coverImage) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (logo) {
        ...
        return yield (0, createBandData_1.default)(data);
    }
    catch (error) {
        throw new ApplicationError_1.ApplicationError(400, error.message, "create band data");
    }
});
exports.default = createBandService;
