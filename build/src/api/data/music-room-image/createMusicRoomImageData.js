...
const createMusicRoomImageData = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield MusicRoomImagesClass_1.MusicRoomImage.create(data);
    }
    catch (error) {
        throw new ApplicationError_1.ApplicationError(400, error.message, "create Music Room");
    }
});
exports.default = createMusicRoomImageData;
