...
const createUserData = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield UserClass_1.default.create(userData);
    }
    catch (error) {
        throw new ApplicationError_1.ApplicationError(400, error.message, "Creation User");
    }
});
exports.createUserData = createUserData;
exports.default = exports.createUserData;
