...
const createMusicRoomData = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield MusicRoomClass_1.MusicRoom.create(data);
    }
    catch (error) {
        throw new ApplicationError_1.ApplicationError(400, error.message, "create music room");
    }
});
exports.default = createMusicRoomData;
