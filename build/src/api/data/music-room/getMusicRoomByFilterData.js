...
const getMusicRoomByFilterData = (filter) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const musicRoom = yield MusicRoomClass_1.MusicRoom.findOne({
...
exports.default = getMusicRoomByFilterData;
