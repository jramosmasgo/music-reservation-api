...
const updateCompanyService_1 = __importDefault(require("../../services/company/updateCompanyService"));
const updateCompanyController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, updateCompanyService_1.default)(req.body, req.params.idCompanu);
