...
const createCompanyService_1 = __importDefault(require("../../services/company/createCompanyService"));
const createCompanyController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { idUser } = req.headers;
        req.body.property = idUser;
        const result = yield (0, createCompanyService_1.default)(req.body);
